...
import { assessmentStages, type AssessmentQuestion } from '../data/mock'
import { fetchAssessmentQuestions } from '../services/api'
...
export function AssessmentEngine() {
  ...
  useEffect(() => {
    fetchAssessmentQuestions().then(setQuestions)
  }, [])
  ...
  if (status === 'generated') return <GeneratedAssessment fileName={fileName} questionCount={questionCount} difficulty={difficulty} questions={questions} onStart={() => setStarted(true)} started={started} onBack={() => setStatus('setup')} />
